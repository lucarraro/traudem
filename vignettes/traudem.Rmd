...
#> Processes: 1
#> Header read time: 0.008867
#> Data read time: 0.003704
#> Compute time: 0.025616
#> Write time: 0.001991
#> Total time: 0.040178
...
#> PitRemove version 5.3.9
#> Input file /tmp/RtmpIwRapb/file1717580e355c/DEM.tif has projected coordinate system.
#> Nodata value input to create partition from file: nan
#> Nodata value recast to float used in partition raster: nan
#> Processes: 1
#> Header read time: 0.006829
#> Data read time: 0.002717
#> Compute time: 0.023438
#> Write time: 0.001950
#> Total time: 0.034934
#> This run may take on the order of 1 minutes to complete.
#> This estimate is very approximate. 
...
#> a dual quad core Dell Xeon E5405 2.0GHz PC with 16GB RAM.
output
#> [1] "/tmp/RtmpIwRapb/file1717580e355c/DEMfel.tif"
```
...
output
#> [1] "/tmp/RtmpIwRapb/file17172ae95ec8/DEMfel.tif"
```
...
output <- taudem_pitremove(file.path(test_dir, "DEM.tif"))
output
#> [1] "/tmp/RtmpIwRapb/file17174cc635cf/DEMfel.tif"
```
...
#> Nodata value recast to float used in partition raster: nan
#> Processes: 1
#> Header read time: 0.007426
#> Data read time: 0.003258
#> Compute time: 0.027154
#> Write time: 0.002076
#> Total time: 0.039913
#> This run may take on the order of 1 minutes to complete.
#> This estimate is very approximate. 
...
![plot of chunk unnamed-chunk-8](traudem-unnamed-chunk-8-1.png)
...
![plot of chunk unnamed-chunk-9](traudem-unnamed-chunk-9-1.png)
The total area of the extracted catchment is 363.82 km^2^.
