...
`traudem` can be combined with the [elevatr](https://cran.r-project.org/package=elevatr) R package to extract a river network from elevation data retrieved from the web. 
